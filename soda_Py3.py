...
if __name__ == '__main__':
	d = HowManySoda()
	d.money = int(input('输入您的金钱数：'))
	d.price_of_drink = int(input('汽水多少钱一瓶：'))
	d.exchange_need_bottles = int(input('多少个瓶子能换一瓶汽水：'))
	d.exchange_need_caps = int(input('多少个瓶盖能换一瓶汽水：'))
	print('初始状态：')
